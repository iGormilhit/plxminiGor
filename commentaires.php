<?php if(!defined('PLX_ROOT')) exit; ?>
	...
	<div id="comments">
		...
		<div id="<?php $plxShow->comId(); ?>" class="comment">
			<blockquote>
				<p class="info_comment"><a class="num-com" href="<?php $plxShow->ComUrl(); ?>" title="#<?php echo $plxShow->plxMotor->plxRecord_coms->i+1 ?>">#<?php echo $plxShow->plxMotor->plxRecord_coms->i+1 ?> : <?php $plxShow->comDate('#num_year(4)-#num_month-#num_day &#64; #hour:#minute'); ?></a><br /> 
					<?php $plxShow->comAuthor('link'); ?> <?php $plxShow->lang('SAID') ?> : </p>
